...
behavior and may remove, edit, or reject contributions, comments, commits, code,
...
the repository's maintainer contact shown on the GitHub organization or owner
profile. Security vulnerabilities must instead use the private process in
[SECURITY.md](SECURITY.md). All complaints will be reviewed promptly and fairly.
...
correction for inappropriate language or behavior, warning for repeated or
serious incidents, temporary suspension for sustained misconduct, and a
permanent ban for a pattern of violations or harassment.
