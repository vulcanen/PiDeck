...
7. Dependency upgrades must update versions, capabilities, and compatibility notes in the relevant docs (the SDK type-declaration/changelog check itself is in [pi-cli-scope.md](pi-cli-scope.md) Compatibility).
